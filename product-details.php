...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="images/indoor/ochid1.jpg<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="334" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									MVR. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">MVR.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Add to cart</button></a>
								<?php } else {?>
							<div class="action" style="color:green">IN STOCK</div>
					<?php } ?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">MVR. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">MVR.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
			...
			<div class="product-price">	
				<span class="price">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">MVR.
